          ...
          <div className="mb-6">
            <div className="flex border-b">
              <button
                ...
                className={`flex-1 py-2 text-center font-semibold transition-colors ${isLogin ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-indigo-500'}`}
              >
                Login
              </button>
              <button
